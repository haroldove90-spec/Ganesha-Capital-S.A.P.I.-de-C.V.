...
export const MOCK_CLIENTS: Client[] = [
  ...
  },
  {
    ...
    financialKnowledge: 'Basic',
    joinDate: '2024-06-15',
    lastInteraction: '2024-07-22',
    salesStage: 'Lead',
    role: 'Client',
    kycStatus: 'Pending',
    accountStatus: 'Active',
    phone_number: '44-2345-6789',
    address: 'Calle Ficticia 123, Juriquilla',
    birth_city: 'León',
  },
  {
    id: '5',
    ...
    financialKnowledge: 'Advanced',
    joinDate: '2020-11-01',
    lastInteraction: '2024-07-25',
    salesStage: 'Advocate',
    role: 'Client',
    kycStatus: 'Verified',
    accountStatus: 'Active',
    phone_number: '99-9876-5432',
    address: 'Paseo de Montejo 456',
    birth_city: 'Veracruz',
  },
  {
    id: '6',
